...
export function ContentHeader({ children, className }: { children?: React.ReactNode, className?: string }) {
  ...
  return (
    <div className="bg-background flex items-center border-b lg:fixed top-[var(--header-height)] start-(--sidebar-width) end-0 in-data-[sidebar-collapsed]:start-(--sidebar-width-collapsed) z-[10] h-(--content-header-height) pe-[var(--removed-body-scroll-bar-size,0px)] transition-[inset-inline-start] duration-200 ease-in-out">
